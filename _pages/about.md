...
My current research focuses on **Image/Video Generation** and **Efficient Low-Level Vision**. I am actively seeking Ph.D. positions for Fall 2027. If you share similar research interests or are open to potential collaborations, please feel free to reach out!
...
# 📝 Publications 
- [AnimeAgent: Is the Multi-Agent via Image-to-Video models a Good Disney Storytelling Artist?](https://arxiv.org/pdf/2602.20664), **Hailong Yan**, Shice Liu, Tao Wang, Xiangtao Zhang, Yijie Zhong, Jinwei Chen, Le Zhang, Bo Li. **Under Review, arXiv 2026**, **[Code](https://github.com/LukasYan30/AnimeAgent)**
- [MorphSIG: Subject-Driven Image Generation via Decoupled Anchoring and Feature Transport](https://github.com/LukasYan30/MorphSIG), **Hailong Yan**, Yongrui Zhang, Xiangtao Zhang, Le Zhang. **Under Review**, **[Code](https://github.com/LukasYan30/MorphSIG)**
...
- [MPFormer: Multimodal Prior-Folding Transformer for Efficient Underwater Image Enhancement](https://github.com/LukasYan30/MPFormer), Leshen Zhang, Boyi Zhao, Yongrui Zhang, Xiangtao Zhang, **Hailong Yan**. **Under Review**, **[Code](https://github.com/LukasYan30/MPFormer)**
